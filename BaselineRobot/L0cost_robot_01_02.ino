...
if (execMotor && execPWM) {
  //***********************************************************************************************
  // THE FOLLOWING CODE HAS BEEN COMMENTED OUT UNTIL A LINE FOLLOWER HARDWARE FIX HAS BEEN FOUND
  //***********************************************************************************************
  // check if last direct command is longer ago than direct command timeout
  // if so, stop robot
  // detach PWM
  //
  // if (directTimer <= loopTimer) {
  //   if (debugSerial) { Serial.println("Direct control timeout - detaching PWM"); }
  //    detachPWM();
  // }
