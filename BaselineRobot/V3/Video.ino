...
/* All routines expect to operate in RGB mode on the camera with low resolution, 176 x 144 pixels.
*/
struct blobLocation {
  long relativeX;
  long relativeY;
...
// This is the main colour detection routine
// *********************************************************************************************
...
// *********************************************************************************************
// Write a mask onto the frame buffer to obscure an area of the frame which detection is not to use,
// such as part of the robot
// *********************************************************************************************
...
// this routine can be selected to aid manual tuning of blob detection
// *********************************************************************************************
...
// This routine can be called to aid manual tuning of object detection
// *********************************************************************************************
...
// This routine can be called to aid manual tning of object detection
// *********************************************************************************************
...
// *********************************************************************************************
// Add an Overlay
// put pixel count graduation ticks around the outside of the frame
// *********************************************************************************************
...
// *********************************************************************************************
// This function copies a frame buffer and converts it from jpeg to BGR
...
// these routines break up the video guidance routines into separate sections to enable 
// scheduling of other functions during these long running routines.
// *********************************************************************************************
...
// ***********************************************************************************
// this function has not been completed but is intended to be called to automatically 
// adjust the camera exposure to maintain a preset luminance
